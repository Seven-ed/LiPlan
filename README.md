...
## Dataset
This repository only contains sample data in the `city/` folder.
The full dataset is available on Aliyun Drive：
🔗 Download link：CityLayout_Dataset
https://www.alipan.com/s/3cEmeRnYP1V
